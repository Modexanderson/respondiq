...
import { loginWithEmail, signupWithEmail, loginWithGoogle } from "../services/firebase";
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-3xl font-bold text-gray-900">Respondiq</span>
          </div>
          <p className="text-gray-500">Intelligent answers from your data</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center justify-center gap-2"
          >
